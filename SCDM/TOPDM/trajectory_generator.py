...
class TrajectoryGenerator(object):
    def __init__(self, planner, traj_len=50, expt_tag="default"):
        ...
        self.log = open("experiments/"+planner.name+"_"+expt_tag+"_log.txt", "a+")
    ...
    def generate_trajectory(self, goal=None, start_state=None, verbose=True):
        ...
        for t in range(self.traj_len):
            ...
            t2 = time.time()
            if verbose:
                write_out = "Step %d. Reward: %f, success: %r, d_pos: %f, d_rot: %f. Best future reward: %f. Took %f seconds!\n" % (t, reward, success, d_pos, d_rot, best_reward, t2-t1)
